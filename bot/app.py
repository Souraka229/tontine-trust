...
def health():
    return jsonify({"status": "ok", "service": "HACKBIT Bot", "version": "2.0"}), 200


@app.route("/", methods=["GET"])
def index():
    return jsonify({"service": "HACKBIT Bot", "status": "running", "dashboard": "/dashboard", "frontend": "See VITE_FLASHBOT_API_URL"}), 200
